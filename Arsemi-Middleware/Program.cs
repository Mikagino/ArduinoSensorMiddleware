...
unsafe {
    ...
    var window = SDL.CreateWindow("Test Window", (int)(1280 * mainScale),
        (int)(720 * mainScale), /*SDLWindowFlags.Resizable | */SDLWindowFlags.Opengl | SDLWindowFlags.HighPixelDensity);
