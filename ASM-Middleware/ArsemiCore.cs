...
namespace Arsemi {
  public class ArsemiCore {
    ...
    private static readonly System.IO.Ports.SerialPort _serialPort = new("COM3", 9600);
    ...
    /// </summary>
    private void ReadLineSerial(object _, System.IO.Ports.SerialDataReceivedEventArgs e) {
    ...
    /// </summary>
    /// <returns>TODO: Current sensor value based on filters, timings, etc.</returns>
    public VariantType GetSensorValue(string sensorName) {
      return 0;
    }
